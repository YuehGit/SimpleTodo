...
public class TodoEditActivity extends AppCompatActivity implements
    ...
    // cancel the elevation of action bar on edit activity
    ...
    private void setupUI() {
        ...
        dataTextView = (TextView) findViewById(R.id.todo_detail_date);
        timeTextView = (TextView) findViewById(R.id.todo_detail_time);
        completeCheckBox = (CheckBox) findViewById(R.id.todo_detail_complete);

        if (todo != null) {
            todoEdit.setText(todo.text);
            UIUtils.setTextViewStrikeThrough(todoEdit, todo.done);
            completeCheckBox.setChecked(todo.done);
        ...
        if (remindDate != null) {
            dataTextView.setText(DateUtils.dateToStringDate(remindDate));
            timeTextView.setText(DateUtils.dateToStringTime(remindDate));
        } else {
            dataTextView.setText(R.string.set_date);
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        // this method will be after user has chosen date from the DatePickerDialog
        Calendar c = getCalendarFromRemindDate();
